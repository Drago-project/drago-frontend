...
export default function SignUpForm() {
  ...
  const handleStudentSubmit = (e) => {
    ...
    console.log("بيانات الطالب:", studentForm); // هنا ترسل بيانات الطالب إلى السيرفر
  }; // --- دوال خاصة بالدكتور ---
  ...
  const handleDoctorSubmit = (e) => {
    ...
    console.log("بيانات الدكتور:", doctorForm); // هنا ترسل بيانات الدكتور إلى السيرفر
  }; // --- دالة لرسم زر "الرجوع" ---
  ...
  if (userType === "doctor") {
    return (
      <>
                {renderBackButton()}{" "}
        {/* --- تم نقل زر الرجوع هنا ليكون ظاهراً --- */}       {" "}
        <h2 className={styles["title"]}>{t("signup.title")}</h2>       {" "}
        <p className={styles["subtitle"]}>{t("signup.subtitle")}</p>       {" "}
        {/* --- فورم الدكتور (المعدل) --- */}       {" "}
