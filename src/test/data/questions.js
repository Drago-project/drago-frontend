...
export function choice(id, domain, skill, difficulty, prompt, choices, correctAnswer, spokenPrompt = "") {
  return { id, type: "choice", domain, skill, difficulty, prompt, choices, correctAnswer, spokenPrompt };
}

export function imageChoice(id, domain, skill, difficulty, prompt, choices, correctAnswer, spokenPrompt = "") {
...
export function speechReading(id, domain, skill, difficulty, prompt, expectedWords, idealTimeMs) {
  return { id, type: "speechReading", domain, skill, difficulty, prompt, expectedWords, idealTimeMs };
}
...
export const questions = {
  ...
  decoding: [
    ...
    speechReading("RD_SR1", "decoding", "word_reading", 1, "اقرأ الكلمة التالية بصوت واضح", ["شمس"], 5000),
    speechReading("RD_SR2", "decoding", "word_reading", 2, "اقرأ الكلمات التالية بصوت واضح", ["قمر", "كتاب", "شجرة"], 10000),
    speechReading("RD_SR3", "decoding", "word_reading", 3, "اقرأ الكلمات التالية بصوت واضح", ["مدرسة", "تفاحة", "سمك", "باب", "قلم"], 15000),
  ],
  spellingMemory: [
    ...
    { id: "SM_003", type: "memorySpan", domain: "spellingMemory", skill: "auditory_memory", difficulty: 2, prompt: "احفظ الكلمات بالترتيب، ثم اكتبها", sequence: ["قلم", "باب", "قمر"], exposureMs: 3500, placeholder: "اكتب الكلمات بالترتيب تفصلها مسافة..." },
    { id: "SM_004", type: "memorySpan", domain: "spellingMemory", skill: "digit_span", difficulty: 3, prompt: "احفظ الأرقام بالترتيب، ثم اكتبها", sequence: ["٣", "٧", "٢", "٥"], exposureMs: 3200, placeholder: "اكتب الأرقام بالترتيب تفصلها مسافة..." },
